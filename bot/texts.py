...
# Кто именно лайкнул — платный гейт (Plus). Про сам лайк сообщаем: иначе
# человек не знает, что у него есть входящие, и покупать ему нечего.
LIKE_LOCKED = (
    "💌 Вы кому-то понравились!\n\n"
    "<i>Кто это — видно в Plus. Там же откроются все входящие лайки.</i>"
)
