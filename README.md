...
интерфейсу, поэтому градиентных заливок и цветных свечений нет.

- Фон `#0a0b0f`, поверхности `#16181f` / `#1c1f28` — холодные серые
  с синим подтоном: рядом с индиго нейтральный серый выглядит грязным
- Акцент `#5b66ff` — один плоский цвет на все главные действия
- Семантика: лайк `#34d399`, пропуск `#f4525f`, верификация `#58a6ff`.
