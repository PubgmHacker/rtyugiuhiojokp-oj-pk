...
Знак марки — факел рассвета с вложенным сердцем (см. tools/brandmark.py).
Иконка — тёмный квадрат в цвете фона приложения со знаком по центру:
на домашнем экране пламя+сердце с градиентом рассвета читается с
расстояния; без отдельного глифа в центре.
...
def main() -> None:
    ...
    # у уменьшенной копии сердце внутри пламени замыливается
