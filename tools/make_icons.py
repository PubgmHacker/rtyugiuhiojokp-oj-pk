...
Знак марки — «две ауры»: два кольца-ауры, пересечение загорается
светом (см. tools/brandmark.py — там смысл и геометрия).
Иконка — тёмный квадрат в цвете фона приложения со знаком по центру:
на домашнем экране тёмная иконка с двумя цветными кольцами различима
