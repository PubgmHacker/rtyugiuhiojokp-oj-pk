...
class Settings(BaseSettings):
    ...
    # ── Zhipu AI (GLM) ──────────────────────────────────────────
    ZHIPU_API_KEY: str = ""
    # Пусто — SDK идёт на материковый open.bigmodel.cn (регистрация там
    # требует китайский/принимаемый телефон). Ключ с Z.ai — международной
    # площадки Zhipu с регистрацией по почте — работает только через
    # https://api.z.ai/api/paas/v4: адрес задаётся этой переменной.
    ZHIPU_BASE_URL: str = ""
