...
class Profile(Base):
    ...
    #: Бонусные суперлайки: паки за Stars (services/plans.py) и остатки от
    #: кейсов — до сентября 2026 кейс выдавал суперлайки, теперь только
    #: оформление анкеты, а накопленное не сгорает. Отдельный пул, а не
    #: прибавка к суточной квоте: квота считается по факту расхода за сутки,
    #: и прибавка к ней возобновлялась бы каждый день сама.
