    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          <motion.div
            className="relative w-full max-w-lg overflow-hidden border-t border-hairline bg-bg-elevated pb-[max(env(safe-area-inset-bottom),16px)]"
            ...
            {(title || !bare) && (
              <div className="flex items-start gap-3 px-5 pb-3">
                <div className="min-w-0 flex-1">
                  {title && (
                    <h2 className="text-[17px] font-semibold leading-tight text-text">
                      {title}
                    </h2>
                  )}
                  {subtitle && (
